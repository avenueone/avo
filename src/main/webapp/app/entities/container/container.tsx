...
export type IContainerState = IPaginationBaseState;
...
export class Container extends React.Component<IContainerProps, IContainerState> {
  ...
  render() {
    const { containerList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="container-heading">
          <Translate contentKey="avoApp.container.home.title">Containers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="avoApp.container.home.createLabel">Create new Container</Translate>
          </Link>
        </h2>
