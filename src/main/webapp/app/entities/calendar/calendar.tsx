...
export type ICalendarState = IPaginationBaseState;
...
export class Calendar extends React.Component<ICalendarProps, ICalendarState> {
  ...
  render() {
    const { calendarList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="calendar-heading">
          <Translate contentKey="avoApp.calendar.home.title">Calendars</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="avoApp.calendar.home.createLabel">Create new Calendar</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="avoApp.calendar.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('description')}>
                  <Translate contentKey="avoApp.calendar.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
...
const mapStateToProps = ({ calendar }: IRootState) => ({
  ...
  totalItems: calendar.totalItems
});
