    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="avoApp.calendar.home.createOrEditLabel">
              <Translate contentKey="avoApp.calendar.home.createOrEditLabel">Create or edit a Calendar</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : calendarEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="calendar-description" type="text" name="description" />
                </AvGroup>
